...
export type WakeUpContactTracer = SyncEvent<backendSipApi.wakeUpUserAgent.Response["status"]>;
...
export async function wakeUpContact(
    ...
    let statusMessage = await backendSipApi.wakeUpUserAgent.run(contact);
