...
export declare function getSims(): Promise<declaration.Types.UserSim[]>;
export declare function getUnregisteredLanDongles(): Promise<declaration.Types.Dongle[]>;
export declare function unlockSim(imei: string, pin: string): Promise<declaration.unlockSim.Response>;
