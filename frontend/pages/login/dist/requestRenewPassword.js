...
function requestRenewPassword() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, new Promise(function (resolve) { return bootbox.prompt({
                        "title": "Account email?",
                        "inputType": "email",
                        "value": $("#email").val() || "",
                ...
                case 1:
                    ...
                    if (!email)
                        return [2 /*return*/];
                    return [4 /*yield*/, api_1.client.sendRenewPasswordEmail(email)];
                case 2:
                    isSuccess = _a.sent();
                    if (!isSuccess) return [3 /*break*/, 3];
                    bootbox.alert("An email that will let you renew your password have been sent to you");
                    return [3 /*break*/, 5];
                case 3: return [4 /*yield*/, new Promise(function (resolve) { return bootbox.dialog({
                        "title": "Not found",
