        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        payload = { imei: imei };
                        return [4 /*yield*/, sipApiFramework.sendRequest(deviceSocket, isDongleConnected.methodName, payload)];
                    case 1:
                        response = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, sipApiFramework.sendRequest(deviceSocket, unlockDongle.methodName, request)];
                    case 1:
                        response = _a.sent();
