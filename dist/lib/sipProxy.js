        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    servers[servers.length] = tls.createServer(options)
                        .on("error", function (error) { throw error; })
                        .listen(_constants_1.c.shared.backendSipProxyListeningPortForGateways, "0.0.0.0")
            ...
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, new Promise(function (resolve) {
                            return dns.resolve4(_constants_1.c.shared.backendHostname, function (error, addresses) {
                                if (error)
                                    throw error;
                                resolve(addresses[0]);
                            });
