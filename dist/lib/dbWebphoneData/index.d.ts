...
export declare const dbWebphoneData: {
    ...
    getUserSimChats: (user: number, imsi: string, maxMessageCountByChat: number) => Promise<import("../../../../frontend/shared/dist/lib/types/webphoneData").Chat<"ENCRYPTED">[]>;
    ...
    fetchOlderMessages: (user: number, imsi: string, chatRef: string, olderThanTime: number, maxMessageCount: number) => Promise<import("../../../../frontend/shared/dist/lib/types/webphoneData").Message<"ENCRYPTED">[]>;
    ...
    newMessage: (user: number, imsi: string, chatRef: string, message: import("../../../../frontend/shared/dist/lib/types/webphoneData").Message.Incoming.Text<"ENCRYPTED"> | import("../../../../frontend/shared/dist/lib/types/webphoneData").Message.Incoming.Notification<"ENCRYPTED"> | import("../../../../frontend/shared/dist/lib/types/webphoneData").Message.Outgoing.Pending<"ENCRYPTED">) => Promise<{
        isUnchanged: boolean;
    }>;
