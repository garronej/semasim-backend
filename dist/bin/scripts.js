    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    return [4 /*yield*/, semasim_gateway_1.commanderFunctions.run("systemctl stop " + _constants_1.c.serviceName + ".service")];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, semasim_gateway_1.commanderFunctions.run("systemctl disable " + _constants_1.c.serviceName + ".service")];
                case 2:
                    _a.sent();
                    return [3 /*break*/, 4];
                case 3:
